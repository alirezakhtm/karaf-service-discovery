...
package com.khtm.osgi.discovery.eureka.impl;
...
public class EurekaService implements EurekaApi {
        ...
        threadHealthCheck = new Thread(() -> {
            while (true) {
                try {
                    ...
                    com.khtm.osgi.discovery.eureka.model.HttpResponse httpResponse = sendRequest(url,
     ...
     * */
    public com.khtm.osgi.discovery.eureka.model.HttpResponse registerServiceInEurekaService(String applicationName, int portNumber,
        ...
        if(response.getEntity() != null){
            ...
            return com.khtm.osgi.discovery.eureka.model.HttpResponse.builder().responseCode(responseCodeNum).result(sb.toString()).build();
        }else{
            client.close();
            //this.healthCheckOtherServices(instanceId);
            return com.khtm.osgi.discovery.eureka.model.HttpResponse.builder().responseCode(responseCodeNum).result(null).build();
        }
    }

    @Override
    public com.khtm.osgi.discovery.eureka.model.HttpResponse unregisterServiceFromEurekaService(String applicationName, String instanceId) throws IOException {
    ...
    public List<Instance> getServiceInfo(String applicationName) throws IOException, JAXBException {
        ...
        com.khtm.osgi.discovery.eureka.model.HttpResponse httpResponse = this.sendRequest(url, null, EurekaService.REQUEST_METHOD_GET);//this.sendGetRequest(url, null);
    ...
    private com.khtm.osgi.discovery.eureka.model.HttpResponse sendRequest(
        ...
        if(response.getEntity() != null) {
            ...
            client.close();
            // return result to
            return com.khtm.osgi.discovery.eureka.model.HttpResponse.builder().responseCode(responseCode).result(sb.toString()).build();
        }else{
            // close client
            client.close();
            // return result to
            return com.khtm.osgi.discovery.eureka.model.HttpResponse.builder().responseCode(responseCode).result(null).build();
        }
    }
    ...
    private void healthCheckOtherServices(String currentInstanceId) throws IOException, JAXBException, ParserConfigurationException, SAXException {
        ...
        applications.forEach(application -> {
            ...
            instances.forEach(instance -> {
                ...
                try {
                    com.khtm.osgi.discovery.eureka.model.HttpResponse response = this.sendRequest(
